...
\begin{keywords}
	\keywordsentry{Fan of Programming}{
	...
	\keywordsentry{Functional Programming}{
		I am an enthusiast of functional programming and devoted to adopting the functional programming paradigm in my daily work.
